   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid1134", tween: [ "style", "${_bot_leg2}", "-moz-transform-origin", [43,20], { valueTemplate: '@@0@@% @@1@@%', fromValue: [43,20]}], position: 0, duration: 0 },
            { id: "eid1135", tween: [ "style", "${_bot_leg2}", "-ms-transform-origin", [43,20], { valueTemplate: '@@0@@% @@1@@%', fromValue: [43,20]}], position: 0, duration: 0 },
            { id: "eid1136", tween: [ "style", "${_bot_leg2}", "msTransformOrigin", [43,20], { valueTemplate: '@@0@@% @@1@@%', fromValue: [43,20]}], position: 0, duration: 0 },
            { id: "eid1137", tween: [ "style", "${_bot_leg2}", "-o-transform-origin", [43,20], { valueTemplate: '@@0@@% @@1@@%', fromValue: [43,20]}], position: 0, duration: 0 },
            { id: "dg33", tween: [ "style", "${_mid_leg2}", "-webkit-transform-origin", [86,22], { valueTemplate: '@@0@@% @@1@@%', fromValue: [86,22]}], position: 0, duration: 0 },
            { id: "eid1138", tween: [ "style", "${_mid_leg2}", "-moz-transform-origin", [86,22], { valueTemplate: '@@0@@% @@1@@%', fromValue: [86,22]}], position: 0, duration: 0 },
            { id: "eid1139", tween: [ "style", "${_mid_leg2}", "-ms-transform-origin", [86,22], { valueTemplate: '@@0@@% @@1@@%', fromValue: [86,22]}], position: 0, duration: 0 },
            { id: "eid1140", tween: [ "style", "${_mid_leg2}", "msTransformOrigin", [86,22], { valueTemplate: '@@0@@% @@1@@%', fromValue: [86,22]}], position: 0, duration: 0 },
            { id: "eid1141", tween: [ "style", "${_mid_leg2}", "-o-transform-origin", [86,22], { valueTemplate: '@@0@@% @@1@@%', fromValue: [86,22]}], position: 0, duration: 0 },
            ...
            { id: "eid1142", tween: [ "style", "${_top_leg2}", "-moz-transform-origin", [30,26], { valueTemplate: '@@0@@% @@1@@%', fromValue: [30,26]}], position: 0, duration: 0 },
            { id: "eid1143", tween: [ "style", "${_top_leg2}", "-ms-transform-origin", [30,26], { valueTemplate: '@@0@@% @@1@@%', fromValue: [30,26]}], position: 0, duration: 0 },
            { id: "eid1144", tween: [ "style", "${_top_leg2}", "msTransformOrigin", [30,26], { valueTemplate: '@@0@@% @@1@@%', fromValue: [30,26]}], position: 0, duration: 0 },
            { id: "eid1145", tween: [ "style", "${_top_leg2}", "-o-transform-origin", [30,26], { valueTemplate: '@@0@@% @@1@@%', fromValue: [30,26]}], position: 0, duration: 0 },
            ...
            { id: "eid1146", tween: [ "style", "${_foot2}", "-moz-transform-origin", [35,47], { valueTemplate: '@@0@@% @@1@@%', fromValue: [35,47]}], position: 0, duration: 0 },
            { id: "eid1147", tween: [ "style", "${_foot2}", "-ms-transform-origin", [35,47], { valueTemplate: '@@0@@% @@1@@%', fromValue: [35,47]}], position: 0, duration: 0 },
            { id: "eid1148", tween: [ "style", "${_foot2}", "msTransformOrigin", [35,47], { valueTemplate: '@@0@@% @@1@@%', fromValue: [35,47]}], position: 0, duration: 0 },
            { id: "eid1149", tween: [ "style", "${_foot2}", "-o-transform-origin", [35,47], { valueTemplate: '@@0@@% @@1@@%', fromValue: [35,47]}], position: 0, duration: 0 },
...
"Buildings": {
   ...
   dom: [
   {
      id: 'CityBurner_Buildings_V12',
      type: 'image',
      rect: ['0px','0px','1024px','768px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/CityBurner_Buildings_V1.png','0px','0px']
   }],
   symbolInstances: [
   ]
   },
